...
import { Default_text_big, Default_text_white, Header, Header_medium_black, Header_medium_white, Header_responsive } from '../styles/Text';
    ...
    return (
        <Content>
            <Section>
                <Left>
                    {windowWidth < 800 ?
                        <><Header_responsive>Hi,
                            <br></br>
                            I’m Vilma Christensen</Header_responsive><Default_text_white>
